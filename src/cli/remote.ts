...
export const REMOTE_SOURCES: RemoteSource[] = [
  {
    ...
    branch: "main",
    dir: "agents/software development",
    files: [
      { name: "PROTOCOL", path: "PROTOCOL.md" },
      { name: "team-lead", path: "team-lead.md" },
      { name: "architect", path: "architect.md" },
      { name: "developer", path: "developer.md" },
